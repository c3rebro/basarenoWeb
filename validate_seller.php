...
if (filter_input(INPUT_SERVER, 'REQUEST_METHOD') === 'POST') {
    ...
    try {
		...
		// ⚠️ Capacity check (admins may bypass if you want)
		if (!bazaar_has_free_slots($conn, (int)$bazaar_id) && $_SESSION['role'] !== 'admin') {
			echo json_encode(['success' => false, 'message' => 'Leider sind alle Plätze für den kommenden Basar bereits vergeben.']);
			exit;
		}
